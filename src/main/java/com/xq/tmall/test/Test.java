...
//					String fileNameFormat = "D:/project/com.xq.tmall_original/web/img/productSingle_small/%d.jpg";
//					String srcFileName = String.format(fileNameFormat, pi.getId());
//					String destFileName = StringUtils.replace(srcFileName, "com.xq.tmall_original", "com.xq.tmall");
//					FileUtils.copyFile(new File(srcFileName), new File(destFileName));
				...
				for (ProductImage pi : pis2) {
					String fileNameFormat = "D:/project/com.xq.tmall_original/web/img/productDetail/%d.jpg";
					String srcFileName = String.format(fileNameFormat, pi.getId());
					String destFileName = StringUtils.replace(srcFileName, "com.xq.tmall_original", "com.xq.tmall");
					FileUtils.copyFile(new File(srcFileName), new File(destFileName));
